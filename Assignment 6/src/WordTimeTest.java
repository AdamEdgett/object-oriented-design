 ...
 * These wordlists are random, sorted lexicographically, and reverse lexico
 *
...
public class WordTimeTest {
    ...
    private StringReverseByLex reverseLexComparator;
    ...
    public WordTimeTest() {
        ...
        this.reverseLexComparator = new StringReverseByLex();
    }
    ...
    public void execute() {
        ...
        for (String file : fileList) {
            for (int num : numStrings) {
                ...
                output(file + ",");
                output("StringByReverseLex,");
                output(num + ",");
                this.mymap = MyMap.empty(this.reverseLexComparator);
                buildMap(file);
                createIterator();
                iterate();
                verifyMap();
